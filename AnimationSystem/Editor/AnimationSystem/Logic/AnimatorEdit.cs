...
namespace JabberwockyWorld.AnimationSystem.Editor
{
    ...
    [CustomEditor(typeof(Animator_script))]
    public class AnimatorEdit : UnityEditor.Editor
    {
        ...
        private Animator_script _animator;
        private bool _isExpanded;

        private void OnEnable()
        {
            _root = serializedObject.FindProperty(nameof(Animator_script.Root));
            ...
            _animator = target as Animator_script;
        }
